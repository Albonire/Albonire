<div align="center" style="background-color: #282828; padding: 20px; border-radius: 15px;">
  ...
  <div style="margin-top: 20px;">
    <img src="https://skillicons.dev/icons?i=react,nextjs,ts,js,tailwind,java,spring,python,nodejs,postgres,mysql,mongodb,aws,git,docker,postman,linux&theme=gruvbox_dark&perline=9" alt="Tecnologías" />
  </div>
    ...
    <tr valign="top">
      <td width="50%" style="padding: 10px;">
        <div style="border: 2px solid #928374; border-radius: 10px; padding: 20px; background-color: #3c3836; text-align: center;">
          ...
          <p>
            <img src="https://skillicons.dev/icons?i=js,html,css&theme=gruvbox_dark" alt="Tecnologías del Proyecto" />
          </p>
          <p>
      ...
      <td width="50%" style="padding: 10px;">
        <div style="border: 2px solid #928374; border-radius: 10px; padding: 20px; background-color: #3c3836; text-align: center;">
          ...
          <p style="color: #b8bb26; font-family: 'Courier New', monospace;">~ Botín Obtenido ~</p>
          <p>
            <img src="https://skillicons.dev/icons?i=react,nodejs,socketio&theme=gruvbox_dark" alt="Tecnologías del Proyecto" />
          </p>
          <p>
